...
<nav class="navbar navbar-expand-md navbar-light bg-dark">
    <a href="<?php echo base_url; ?>index.php" class="navbar-brand py-2 md-2"><i class="fas fa-school text-warning fa-2x"></i></a>
    ...
    <div class="collapse navbar-collapse" id="nav">
        ...
        <div class="ml-auto d-flex">
            <button class="btn btn-outline-danger btn-sm mx-2" style="border-radius: 12px;">
                <a class="nav-link text-light text-uppercase font-weight-bold py-1" href="<?php echo base_url; ?>Exportproject/admin-login.php">Admin</a>
            </button>                     
            <button class="btn btn-outline-info btn-sm mx-2" style="border-radius: 12px;">
                <a class="nav-link text-light text-uppercase font-weight-bold py-1" href="<?php echo base_url; ?>Importproject/login.php">User</a>
            </button> 
            <button class="btn btn-outline-warning btn-sm mx-2" style="border-radius: 12px;">
                <a class="nav-link text-light text-uppercase font-weight-bold py-1" href="<?php echo base_url; ?>Developer-team.php">Developer's</a>
            </button> 
        </div>
    </div>    
</nav>
