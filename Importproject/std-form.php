...
<body class="bg-image" style="background-size: 200vh; background-image:url('https://slidechef.net/wp-content/uploads/2021/11/Real-Classroom-Background.jpg');">
    ...
    <div class="container">
        <div class="container-fluid bg-3 text-center">
            <h3></h3>
            <a href="<?php echo base_url; ?>Importproject/student.php" class="btn btn-info pull-right" style='margin-top:-30px'>
            ...
            <div class="panel panel-danger">
                ...
                <form class="form-horizontal container" method="post" enctype="multipart/form-data">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-5">Teacher Name :</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-3 col-sm-offset-5">
                                <a href="<?php echo base_url; ?>Importproject/student.php" class="btn btn-danger mx-3" style="border-radius: 10px;">Cancel</a>
