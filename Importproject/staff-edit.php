    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $folderPath.$filename)) {
            ...
            if ($update) {
                ...
                header("Location:" . base_url . "staff.php"); // Redirect on success
                exit();
            } else {
                $_SESSION['alert'] = "Data update failed!";
                header("Location:" . base_url . "staff-edit.php?id=" . $id); // Redirect on failure
                exit();
            }
        } else {
        ...
        <form class="form-horizontal container" method="post" enctype="multipart/form-data">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <a href="<?php echo base_url; ?>Importproject/staff.php" class="btn btn-danger mx-3" style="border-radius: 10px;">Cancel</a>
