    ...
    <div class="collapse navbar-collapse" id="nav">
        <?php if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === true) { ?>                  
            ...
            <div class="ml-auto d-flex float-right p-2">
                <a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Importproject/logout.php">LogOut</a>                 
            </div>
        <?php } else { ?>
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Importproject/login.php">Login</a></li>
                <li class="nav-item"><a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Importproject/register.php">Register</a></li>
            </ul>
        <?php } ?>
    </div>    
</nav>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center" style="height: 75vh;">
            <div class="text-center">
                ...
                <div class="mt-5">
                    <a href="<?php echo base_url; ?>Importproject/staff.php" class="btn btn-primary  mx-4 btn-lg " style="font-size: 18px;">Staff</a>
                    <a href="<?php echo base_url; ?>Importproject/student.php" class="btn btn-success mx-4 btn btn-lg" style="font-size: 18px;">Student</a>
                </div>
            </div>
        </div>
    </div>
