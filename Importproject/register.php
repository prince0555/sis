...
<nav class="navbar navbar-expand-md navbar-light bg-dark">
    <a href="<?php echo base_url; ?>/index.php" class="navbar-brand"><i class="fas fa-school text-warning fa-2x"></i></a>
...
<!-- end nav -->
  <div class="container">
  <div class="container col-12 col-md-7 col-lg-6  mt-1">
    ...
    <div class="card-body">        
        ...
        <div class="form-group">
            ...
            <a href="<?php echo base_url; ?>/Importproject/login.php" class="btn btn-block bg-info text-light">Login</a>
