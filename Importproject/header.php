...
<nav class="navbar navbar-expand-md navbar-light bg-dark">
    <a href="<?php echo base_url; ?>Importproject/index.php" class="navbar-brand py-3 md-3"><i class="fas fa-school text-warning fa-2x mx-2"></i></a>
    ...
    <?php if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === true) { ?>                  
        ...
        <div class="ml-auto d-flex float-right">
            <a class="nav-link text-light text-uppercase font-weight-bold mt-3 p-2" href="<?php echo base_url; ?>Importproject/logout.php">LogOut</a>                     
        </div>
        <?php } else { ?>
            <ul class="navbar-nav">
