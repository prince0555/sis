...
if (isset($_POST['delete'])) {
    $delete = $_POST['delete'];
    $delete_num = "DELETE FROM tbl_student WHERE id='$delete'";
...
<body class="bg-image" style="background-size: 200vh; background-image:url('https://slidechef.net/wp-content/uploads/2021/11/Real-Classroom-Background.jpg');">
    <?php include('std-index.php'); ?>

    <div class="container-fluid py-5">
        <div class="container-fluid bg-3 text-center">
            <a href="<?php echo base_url; ?>Importproject/std-form.php" class="btn btn-info pull-right" style='margin-top:-10px; margin-right:10px;'>
                <span class="glyphicon glyphicon-plus-sign"></span> Add Record</a>
            <a href="<?php echo base_url; ?>Importproject/dashboard.php" class="btn btn-warning pull-left" style='margin-top:-10px; margin-right:10px;'>
                <span class="glyphicon glyphicon-backward"></span> Back</a>    
        </div>

        <div class="panel panel-info" style="margin-top:10px">
            <h4 class="text-info text-uppercase font-weight-bold">Student Information</h4>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $query['roll_no']; ?></td>
                                    <td><?php echo $query['name']; ?></td>
                                    <td><?php echo $query['father_name']; ?></td>
                                    <td><?php echo $query['dob']; ?></td>
                                    <td><?php echo $query['gender']; ?></td>
                                    <td><?php echo $query['class']; ?></td>
                                    <td><?php echo $query['section']; ?></td>
                                    <td><?php echo $query['mobile_no']; ?></td>
                                    <td><?php echo $query['class_teacher_name']; ?></td>
                                    <td><?php echo $query['school_name']; ?></td>
                                    <td><?php echo $query['address']; ?></td>
                                    <td>
                                        <img src="<?php echo "./imagess/" . $query['school_name'] . "/student/" . "/" . $query['image_name']; ?>" width="75" height="75" alt="student_image_name">
                                    </td>
                                    <td><?php echo $query['updated_at']; ?></td>

                                    <td>
                                        <form method="post">
                                            <a href="<?php echo base_url; ?>Importproject/student-edit.php?id=<?php echo $query['id']; ?>" class="btn btn-success mt-3 mx-3" style="border-radius: 10px;"><i class="fas fa-edit" style="font-size: 20px;"></i></a>
                            ...
                            ?>
                            <tr>
                                <td class='text-center text-danger' colspan='15'>Record Not Found</td>
                            </tr>
                        <?php
                        }
                        ?>
