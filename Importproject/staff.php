...
<div class="container-fluid bg-3 text-center"> 
    <a href="<?php echo base_url; ?>Importproject/staff-form.php" class="btn btn-info pull-right" style='margin-top:-10px; margin-right:10px;'>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr align="center">
                            ...
                            <td>
                            <form method="post">
                                    <a href="<?php echo base_url; ?>Importproject/staff-edit.php?id=<?php echo $query['id']; ?>" class="btn btn-success mt-3 mx-3" style="border-radius: 10px;"><i class='fas fa-edit' style="font-size: 20px;"></i></a>
