...
<section>
    ...
    <div class="container-fluid py-5">
        <div class="container-fluid bg-3 text-center">
            <a href="<?php echo base_url; ?>Exportproject/std-select-school.php" class="btn btn-warning pull-left">
                <span class="glyphicon glyphicon-backward"></span> Back
            </a>

            <?php { ?>
                <a href="<?php echo base_url; ?>Exportproject/allstudent.php?school=<?php echo $selectedSchool ?>&class=<?php echo $class ?>&section=<?php echo $section ?>" class="btn btn-success pull-right">
