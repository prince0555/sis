    ...
    <div class="container col-12 col-md-7 col-lg-6  mt-5">
        <div class="card shadow">
            ...
            <div class="card-body bg-light">
                <form action="<?php echo base_url; ?>Exportproject/student-list.php" method="post"> <!-- Use the correct action and POST method -->
                ...
                <div class="mt-3">
                <!-- Back buttan -->
                 <a href="<?php echo base_url; ?>Exportproject/index.php" class="btn btn-black btn-secondary">Back</a>
            </div>
            </div>
        </div>
    </div>
