...
<?php require_once '../config.php'; ?>
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-dark fixed-top">
    <a href="<?php echo base_url; ?>index.php" class="navbar-brand py-2">
    ...
    <?php if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === true) { ?>                  
      ...
      <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item p-2">
          <a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Exportproject/staff-select-school.php">Staff</a>
        </li>
        <li class="nav-item p-2">
          <a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Exportproject/std-select-school.php">Student</a>
        </li> 
        </ul>  
 
        <div class="ml-auto d-flex float-right p-2">
                <a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Exportproject/logout.php">LogOut</a>                 
            </div>                   
      <?php } else { ?>
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Exportproject/login.php">Login</a></li>
                <li class="nav-item"><a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>Exportproject/register.php">Register</a></li>
            </ul>
        <?php } ?>  
    </div>
  </nav>
  ...
  <section class="d-flex justify-content-center align-items-center text-container" style="height: 75vh;">
    <div class="container text-center">
      ...
      <div class="mt-5">
        ...
        <a href="<?php echo base_url; ?>Exportproject/std-select-school.php" class="btn btn-info btn-lg mt-4 mx-5">Student</a>
      </div>
    </div>
  </section>
